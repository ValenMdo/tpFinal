...
public class Ticket {
    ...
    public void setTecnico(Tecnico tecnico) throws Exception {
        if (!tecnicos.contains(tecnico)) {
            tecnicos.add(tecnico);
            tecnico.atenderTicket(this);
            System.out.println("Tecnico: " + tecnico.toString() + " ha sido asignado a este ticket.");
        }
    }
    ...
    public void desasignarTecnico(Tecnico tecnico) {
        if (tecnicos.contains(tecnico)) {
            ...
            System.out.println("Técnico " + tecnico.getNombre() + " ha sido desasignado del ticket.");
        }else{
            System.out.println("El técnico: " + tecnico.getNombre() + " no estaba asignado a este ticket.");
        }
    }
